            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse position-relative" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link"  href="homePage.jsp"><b>Home</b></a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link active " aria-current="page" href="applyLoan.jsp">Loan</a>
                        </li>
                    </ul>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-xl-5 col-md-8">
                    <form class="bg-gradient rounded-5 shadow-5-strong p-5 " id="frosted-glass" action="../apply-loan">
                        <center><h1><div class="  ">Loan Application</div></h1></center>
                        <center><div><h3 class="text-secondary " style="padding: 20px;">Experience the power of seamless Banking.</h3></div></center>

                        <div class="form-outline mb-4">
                            <input type="number" id="loanAmount" class="form-control" name="loanAmount" required />
                            <label class="form-label" for="loanAmount">Loan Amount</label>
                        </div>

                        <!-- Submit button -->
                        <input type="submit" class="btn btn-primary btn-block mb-4" value="Apply" >
