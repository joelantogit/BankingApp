            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse position-relative" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active " aria-current="page" href="transferMoney.jsp">Transfer</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-xl-5 col-md-8">
                    <form class="bg-gradient rounded-5 shadow-5-strong p-5 " id="frosted-glass" action="../transfer">
                        <center><h1><div class="  ">Transfer Failed!</div></h1></center>
                        <center><div><h3 class="text-secondary">Please verify 'To' username and account balance.</h3></div></center>
