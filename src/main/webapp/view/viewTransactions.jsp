        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-xl-5 col-md-8">
                    <form class="bg-gradient rounded-5 shadow-5-strong p-5 " id="frosted-glass" action="../view-transactions">
                        <center><h1><div class="  ">View Transactions</div></h1></center>
                        <center><div><h3 class="text-secondary p-5">Select date range</h3></div></center>

                        <div class="form-outline mb-4">
                            <input type="text" id="fromDate" class="form-control" required name="fromDate" />
                            <label class="form-label" for="fromDate">From</label>
                        </div>
                        <div class="form-outline mb-4">
                            <input type="text" id="toDate" class="form-control"  required name="toDate" />
                            <label class="form-label" for="toDate">To</label>
                        </div>

                        <!-- Submit button -->
                        <input type="submit" class="btn btn-primary btn-block mb-4" value="Show">
                    </form>
                </div>
            </div>
        </div>
