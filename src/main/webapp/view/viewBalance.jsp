                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item active" href="viewBalance.jsp" aria-current="page" >Check Balance</a></li>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-xl-5 col-md-8">
                    <div class="bg-gradient rounded-5 shadow-5-strong p-5 " id="frosted-glass" action="../change-password">
                        <center><h1><div class="  ">Account Balance</div></h1></center>
                        <center><div><h3 class="text-secondary p-5"><%= session.getAttribute("balance")%>$</h3></div></center>
